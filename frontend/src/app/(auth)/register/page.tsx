  ...
  return (
    <div className="space-y-8">
      <div className="text-center">
        ...
        <p className="mt-3 font-serif text-paper/60">Create your account to get started.</p>
      </div>

      <form onSubmit={handleSubmit} className="space-y-5 rounded-sm border border-hairline bg-surface p-8">
        <div>
          <label className="label-mono mb-2 block text-paper/50">Name</label>
          <input
            type="text"
            value={name}
      ...
      <p className="text-center font-serif text-paper/50">
        ...
        <Link href="/login" className="text-gold underline-offset-4 transition-colors hover:underline">
          Sign in
        </Link>
      </p>
    </div>
